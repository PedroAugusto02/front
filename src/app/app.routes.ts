...
import { AtividadesComponent } from './pessoas/atividades/atividades.component';
...
import { JobsComponent } from './pessoas/jobs/jobs.component';
...
export const routes: Routes = [
  ...
  { 
    ...
    children: [
      ...
      { path: 'usuarios', component: UsuarioComponent, data: { instance: UsuarioComponent }},
